...
Once the regions of interest is defined, we can generate the rearrangement plot.
...
The dimensions of the Giemsa stain track can be modified using the parameters *lower_limit_karyotype* and *upper_limit_karyotype*.
...
ann_dot_col="darkred",
ann_size_dot=.5,
ann_y_title="SNV-VAF", #Label for y-axis
ann_rel_size=.4 #Relative size to main plot
)
