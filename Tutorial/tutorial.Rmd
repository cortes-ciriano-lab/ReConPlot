...
While the primary focus of *ReConPlot* is the visualization of complex somatic copy number and SVs in the context of cancer, the functionalities provided can be used to visualize genomics data from non-cancer samples, such as somatic aberrations detected in normal tissues, single-cell whole-genome data or others. Currently, *ReConPlot*  supports the following builds of the human reference genome: GRCh37, GRCh38 and T2T-CHM13.  
...
```{r, echo=TRUE, fig.width = (9.5/2.54), fig.height=(5.5/2.54), fig.align='center'}
...
```{r, echo=TRUE , fig.width = (12/2.54), fig.height=(5.5/2.54), fig.align='center'}
chrs=c("chr10")
chr_selection = data.frame(
  chr=chrs,
...
```{r, echo=TRUE, fig.width = (19/2.54), fig.height=(5.5/2.54), fig.align='center'}
plot = ReConPlot( sv_data,
cn_data,
chr_selection=chr_selection,
...
```{r, echo=TRUE, fig.width = (19/2.54), fig.height=(6/2.54), fig.align='center' , eval=T}
plot = ReConPlot( sv_data,
cn_data,
chr_selection=chr_selection,
...
<!-- ```{r, echo=F, fig.width = (19/2.54), fig.height=(5.5/2.54), fig.align='center', eval=FALSE} -->
<!-- plot = ReConPlot( sv_data, -->
<!-- cn_data, -->
<!-- chr_selection=chr_selection, -->
<!-- genes=c("MDM2","MDM4","MYC","CDK4","EGFR","CDKN2A","CCND2"), -->
...
```{r, eval=FALSE, echo=TRUE, fig.width = (12/2.54), fig.height=(4/2.54), fig.align='center'}
pdf("example_ReConPlot.pdf", width=(19/2.54), height=c(5/2.54))
print(p)
dev.off()
```
Note that we divide by 2.54 to convert from inches to centimetres.
